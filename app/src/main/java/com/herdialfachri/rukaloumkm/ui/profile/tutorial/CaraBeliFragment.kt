...
class CaraBeliFragment : Fragment() {

    private var _binding: FragmentCaraBeliBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCaraBeliBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolbarCarabeli.setNavigationOnClickListener {
